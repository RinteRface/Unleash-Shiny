...
<h2 class="white n">Part2. Develop Shiny Custom Inputs</h1>
...
For Shiny inputs, it is slightly more complex `r ji("demon")`!

---
class: header_background
# A.4 Practice 1: Bulma JS for Shiny
...
class: header_background
# B.1.2 The Shiny input system
## The binding steps: **get the value**
...
class: header_background
# B.1.2 The Shiny input system
## The binding steps: **set and update**
.small[
...
---
class: header_background
# B Practice 2: Box on Steroids for `{shinydashboard}`
